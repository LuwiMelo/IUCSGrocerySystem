...
{
    $LatestSchoolYear;
    $statement = $dbh->prepare("SELECT MAX(SupplierID)+1 AS 'NewSupplierID' FROM tblsuppliers");
    $statement->execute();
    $row = $statement->fetch();
    
    if (!empty($row)) {
          
          $SupplierIDRetrieve = $row['NewSupplierID'];
        ...
        <div class="col-md-3"></div>
           ...
           <div class="col-md-5">
               ...
               <br>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">                                            
                            <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                            <input type="text" class="form-control" placeholder="e.g. Emilus Supermart" name="SupplierName" id="SupplierName">
                            </div>                                            
              ...
              <div class="form-group">
                   ...
                   <div class="col-md-9">                                            
                        <textarea class="form-control" rows="5" name="SupplierDetails" id="SupplierDetails"></textarea>
