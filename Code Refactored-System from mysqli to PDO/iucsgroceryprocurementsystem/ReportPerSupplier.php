...
<div class="row">
    ...
    <form method="post" action="GenerateReportPerSupplier.php">
        ...
        <br>
         <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select class="form-control select" name="SelectedSupplier" id="SelectedSupplier">
                                                <?php 
                                                   ...
                                                   $query = $conn->query("SELECT * FROM tblSuppliers");
    ...
    if($rowCount > 0){
        ...
        <br>
               ...
               <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                  <input type="date" class="form-control" name="ReportStartDate" id="ReportStartDate" >
             ...
             <br>
               ...
               <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                  <input type="date" class="form-control" name="ReportEndDate" id="ReportEndDate" >
             ...
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             <button type="submit" class="btn btn-md btn-success">GENERATE REPORT</button>
             <Br>
                 <br>
                 <br>
