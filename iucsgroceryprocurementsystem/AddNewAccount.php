...
<div class="row">
    <form action="InsertNewAccount.php" method="post" id="RegistrationForm" name="RegistrationForm">
 <br>
    <br>
           ...
           <div class="col-md-5">
              ...
              <div class="form-group">
                    ...
                    <div class="col-md-9">                                            
                            ...
                            <input type="text" class="form-control" value="<?php echo $LastUserIDRetrieve; ?>" readonly name="UOMID" id="UOMID">
                            </div>                                            
                            <span class="help-block">This user ID is system generated.</span>
                        
                            <input type="hidden" name="UserID" id="UserID" value="<?php echo $LastUserIDRetrieve; ?>">
                    </div>
            </div>
               <br>
               <br>
               ...
               <br>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">                                            
                            <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                            <input type="text" class="form-control" placeholder="" name="UserFirstName" id="UserFirstName">
                            </div>                                            
               ...
               <br>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-md-9">                                            
                            <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                            <input type="text" class="form-control" placeholder="" name="UserLastName" id="UserLastName">
                            </div>                                            
                            <span class="help-block"></span>
                    </div>
            </div>
               ...
               <br>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-md-9">                                            
                            <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                            <input type="text" class="form-control" placeholder="" name="UserUsername" id="UserUsername">
                            </div>                                            
                            <span class="help-block"></span>
                    </div>
            </div>
               ...
               <div class="form-group">
                                        ...
                                        <div class="col-md-9  col-xs-12">                                                                                            
                                            <select class="form-control select" name="PositionLevel" id="PositionLevel">
                                                   <option value="0">Non-supervisory</option>
                                                   <option value="1">Supervisory</option>
