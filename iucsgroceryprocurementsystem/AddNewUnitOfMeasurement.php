...
<div class="row">
    <form action="InsertNewUnitOfMeasurement.php" method="post">
 <br>
    <br>
   <Center><h1>Add New Unit Of Measurement</h1></Center>
           ...
           <div class="col-md-5">
              ...
              <div class="form-group">
                    ...
                    <div class="col-md-9">                                            
                            ...
                            <input type="text" class="form-control" value="<?php echo $SupplierIDRetrieve; ?>" readonly name="UOMID" id="UOMID">
                            </div>                                            
               ...
               <br>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">                                            
                            <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                            <input type="text" class="form-control" placeholder="e.g. 375ml" name="UnitOfMeasurement" id="UnitOfMeasurement">
                            </div>                                            
              ...
              <div class="form-group">
                   ...
                   <div class="col-md-9">                                            
                        <textarea class="form-control" rows="5" name="UOMDetails" id="UOMDetails"></textarea>
