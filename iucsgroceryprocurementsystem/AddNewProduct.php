           ...
           <div class="col-md-5">
              ...
              <div class="form-group">
                    ...
                    <div class="col-md-9">                                            
                            ...
                            <input type="text" class="form-control" value="<?php echo $SupplierIDRetrieve; ?>" readonly name="ProductID" id="ProductID">
                            </div>                                            
               ...
               <br>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">                                            
                            <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                            <input type="text" class="form-control" placeholder="e.g. Head and Shoulders" name="ProductName" id="ProductName">
                            </div>                                            
              ...
              <div class="form-group">
                   ...
                   <div class="col-md-9">                                            
                        <textarea class="form-control" rows="5" name="ProductDetails" id="ProductDetails"></textarea>
...
<div class="row">
    ...
    <div class="col-md-5">
    <button class="btn btn-lg btn-success" id="btnSubmitAddNewProduct">ADD NEW PRODUCT</button>
...
<script>
 ...
 $("#btnAddUnitSuccess").click(function () {
     ...
     var SupplierIDToBeAdded = $("#SelectedSupplier").val();
       ...
       dataTable.row.add([UnitToBeAdded,SupplierToBeAdded,PriceToBeAdded,UnitIDToBeAdded, SupplierIDToBeAdded,'<button class="btn btn-danger btn-md" id="DeleteRow"> Remove </button>']).draw();
