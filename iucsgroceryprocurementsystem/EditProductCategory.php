...
<div class="row">
    <form action="UpdateProductCategory.php" method="post">
 <br>
    <br>
   <Center><h1>Edit Product Category</h1></Center>
           ...
           <div class="col-md-5">
              ...
              <div class="form-group">
                    ...
                    <div class="col-md-9">                                            
                            ...
                            <input type="text" class="form-control" value="<?php echo $ProductCategoryIDRetrieve; ?>" readonly name="ProductCategoryID" id="ProductCategoryID">
                            </div>                                            
                            <span class="help-block">This product category ID is system generated.</span>
                        
                            <input type="hidden" name="SupplierIDPOST" id="SupplierIDPOST" value="<?php echo $ProductCategoryIDRetrieve; ?>">
                    </div>
            </div>
               <br>
               <br>
               ...
               <br>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">                                            
                            <div class="input-group">
                            <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                            <input type="text" class="form-control" placeholder="e.g. Shampoo/Conditioners" name="ProductCategory" id="ProductCategory" value = "<?php echo $ProductCategoryNameRetrieve; ?>">
                            </div>                                            
              ...
              <div class="form-group">
                   ...
                   <div class="col-md-9">                                            
                        <textarea class="form-control" rows="5" name="ProductCategoryDetails" id="ProductCategoryDetails"><?php echo $ProductCategoryDetailsRetrieve; ?></textarea>
