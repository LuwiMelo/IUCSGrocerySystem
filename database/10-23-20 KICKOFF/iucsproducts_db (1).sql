...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 23, 2020 at 09:50 AM
...
CREATE TABLE IF NOT EXISTS `tblformtransactions` (
...
--
-- Dumping data for table `tblformtransactions`
--

INSERT INTO `tblformtransactions` (`TransactionID`, `TransactionDetails`, `TransactionDate`, `TransactionUserID`) VALUES
(1, 'Test', '2018-11-11 00:00:00', 4),
(2, '', '2018-11-13 00:00:00', 4),
(3, '', '2018-11-18 00:00:00', 4),
(4, '', '2018-12-17 00:00:00', 4),
(5, '', '2019-03-04 00:00:00', 8),
(6, '', '2019-03-05 00:00:00', 13),
(7, '', '2019-07-04 00:00:00', 7),
(8, '', '2019-12-07 00:00:00', 7);
...
CREATE TABLE IF NOT EXISTS `tblproductxuom` (
...
CREATE TABLE IF NOT EXISTS `tbltakehomepaythreshold` (
...
INSERT INTO `tbltransactiondetails` (`TransactionDetailID`, `TransactionDetailProductID`, `TransactionDetailUOMID`, `TransactionDetailQuantity`, `TransactionDetailTransactionID`, `TransactionDetailsPricePerUnit`) VALUES
(1, 28, 17, 5, 1, 7.25),
(2, 18, 9, 2, 1, 15.9),
(3, 3, 23, 3, 2, 29.3),
(4, 36, 26, 5, 2, 48.85),
...
CREATE TABLE IF NOT EXISTS `tblunitofmeasurement` (
...
ALTER TABLE `tblformtransactions`
 ADD PRIMARY KEY (`TransactionID`), ADD KEY `TransactionUserID_idx` (`TransactionUserID`);
...
ALTER TABLE `tblproducts`
 ADD PRIMARY KEY (`ProductID`), ADD KEY `ProductCategoryID_idx` (`ProductCategoryID`);

--
-- Indexes for table `tblproductxuom`
--
ALTER TABLE `tblproductxuom`
 ADD PRIMARY KEY (`ProductXUOMProductID`,`ProductXUOMUOMID`), ADD KEY `ProductXUOMUOMID_idx` (`ProductXUOMUOMID`);
...
ALTER TABLE `tbltransactiondetails`
 ADD PRIMARY KEY (`TransactionDetailID`), ADD KEY `TransactionDetailProductID_idx` (`TransactionDetailProductID`), ADD KEY `TransactionDetailUOMID_idx` (`TransactionDetailUOMID`), ADD KEY `TransactionDetailTransactionID_idx` (`TransactionDetailTransactionID`);
...
ALTER TABLE `tblusers`
 ADD PRIMARY KEY (`UserID`), ADD KEY `UserUserTypeID_idx` (`UserUserTypeID`);
